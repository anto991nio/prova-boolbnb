            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="user_img_path" class="col-md-4 col-form-label text-md-right">{{ __('User Image') }}</label>
                            <div class="col-md-6">
                                <input type="file" accept=".jpg, .jpeg, .png, .bmp, .gif, .svg, .webp" class="form-control-file  @error('user_img_path') is-invalid @enderror" id="user_img_path" name="user_img_path">
                                @error('user_img_path')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
